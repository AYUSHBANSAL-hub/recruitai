...
const TestimonialsSection = () => {
  const testimonials = [
    {
      quote: "HirezApp has revolutionized our hiring process. We've reduced our time-to-hire by 60% and found better-qualified candidates.",
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            See what our customers say about HirezApp
          </p>
        </div>
