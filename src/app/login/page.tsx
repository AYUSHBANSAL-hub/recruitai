                ...
                >
                  ...
                  >
                    <p className="text-white italic">
                      "HirezApp cut our screening time by 89% and improved our quality of hires dramatically."
                    </p>
            ...
            <div className="bg-white p-8 md:p-12">
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600">Sign in to access your HirezApp dashboard</p>
                </div>
